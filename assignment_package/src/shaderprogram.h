...
public:
    ...
    int unifCamPos; // A handle for the "uniform" mat4 representing view matrix in the vertex shader used to find vertex distance from camera
...
public:
    ...
    // Pass dimensions of the screen to the GPU
    ...
    void drawInterleaved(Drawable &d, int textureSlot, bool transparrent);
