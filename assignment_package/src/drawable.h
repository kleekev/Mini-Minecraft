...
protected:
    ...
    GLuint m_bufVertOpaque;
    GLuint m_bufVertTransparrent;
    GLuint m_bufUV;

    bool m_idxOpaqueGenerated; // Set to TRUE by generateIdx(), returned by bindIdx().
    bool m_idxTransparrentGenerated;
    bool m_posGenerated;
    bool m_norGenerated;
    bool m_colGenerated;
    bool m_vertOpaqueGenerated;
    bool m_vertTransparrentGenerated;
    bool m_uvGenerated;
...
public:
    ...
    void generateIdxTransparrent();
    void generatePos();
    void generateNor();
    void generateCol();
    void generateVertOpaque();
    void generateVertTransparent();
    void generateUV();

    bool bindIdxOpaque();
    bool bindIdxTransparrent();
    bool bindPos();
    bool bindNor();
    bool bindCol();
    bool bindVertTransparent();
    bool bindVertOpaque();
    bool bindUV();
};
